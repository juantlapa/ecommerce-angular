...
router.post('/users/users', profileValidations, validate, authMiddleware, isAdmin, createUser);

// Actualizar perfil del usuario
router.put('/users/profile', profileValidations, validate, authMiddleware, updateUserProfile);
